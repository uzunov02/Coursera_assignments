...
def get_scatter(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        title='Correlation between Payload Mass (kg) and successful launches for all Sites')
        return fig
    else:
        fig = px.scatter(filtered_df[filtered_df['Launch Site'] == entered_site],
        x='Payload Mass (kg)', y='class',
        color='Booster Version Category',
        title=f'Correlation between Payload Mass (kg) and successful launches for {entered_site}')
        return fig
